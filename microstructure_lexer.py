...
__all__ = ['MicroStructureLexer']


class MicroStructureLexer(RegexLexer):
    ...
    tokens = {
        ...
        'root': [
            ...
            (r'believes', Keyword.Constant),
            (r'contradicts', Keyword.Declaration),
            (r'\.\.\.|=>', Punctuation),
            (r'\+\+|--|~|&&|\?|:|\|\||\\(?=\n)|'
            ...
            (r'(true|false|NaN|PI|concept|holder)\b', Keyword.Constant),
