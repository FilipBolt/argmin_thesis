...
% The ontology contains the following top level classes : \texttt{crime}, 
% \texttt{disease}, \texttt{drug}, \texttt{economy\_cost}, \texttt{human\_being}, 
% \texttt{human\_rights}, \texttt{organization}, \texttt{plant}, \texttt{religion}, 
% \texttt{science}, \texttt{society\_effect}, \texttt{status\_behavior}, and
% \texttt{war} 
